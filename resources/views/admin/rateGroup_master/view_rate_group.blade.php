                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            ...
                            <span style="float:right;"><a href="{{route('admin.add-rate-group')}}" class="btn btn-outline-primary">Add Rate Group</a></span>
                        </div>
                        <div class="card-body">
                                            ...
                                            @foreach ($Rategroup as $val)
                                                <tr>
                                                    ...
                                                    <td> <a style="color:blue"
                                                            href="{{ route('admin.edit-rate-group', ['id' => $val->id]) }}">
...
@section('script')
<script>
    var callurl = "{{ route('admin.delete-rate-group')}}";
    var view = "{{ route('admin.view-rate-group') }}";
</script>
