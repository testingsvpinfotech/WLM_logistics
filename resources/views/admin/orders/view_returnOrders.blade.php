            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="m-4">
                        ...
                        <form action="{{route('admin.view-return-orders')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a href="{{route('admin.view-return-orders')}}" class="btn btn-outline-danger mt-4"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </form>
                        <br>
